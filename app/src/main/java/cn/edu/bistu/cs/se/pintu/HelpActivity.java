...
public class HelpActivity extends ListActivity{
	...
	public class HelpView extends LinearLayout{
		...
		this.addView(title, new LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT));
		
		dialog = new TextView(context);
		dialog.setTextColor(Color.RED);
		dialog.setTextSize(16);
		dialog.setText(mdialog);	
		this.addView(dialog, new LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT));
